...
<#else>
<input name="pcStartDate" id="start_date" value='' readonly="readonly" />
</#if>
</td>
</tr>
<tr>
...
<#if prepareCourse??>
<input name="pcEndDate" id="end_date" value='${prepareCourse.endDate?string('yyyy-MM-dd')}' readonly="readonly" />
<#else>
<input name="pcEndDate" id="end_date" value='' readonly="readonly" />
</#if>
</td>
</tr>
...
<option value="100">直接上传 Word 文档(.doc、.docx)方式</option>
</select>
</td>
</tr>
</#if>
...
<iframe id="DHtml_Frame" src="${SiteUrl}manage/fckeditor/editor/fckeditor.jsp?InstanceName=DHtml&Toolbar=Default"
 width="98%" height="500" frameborder="0" scrolling="no"></iframe>
</td>
</tr>
<tr>
<td></td><td>
