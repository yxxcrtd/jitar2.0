...
<#if action?? >
   ...
   <input name='cmd' type='hidden' value='' />
    ...
    <tr>
    <td class='table_action_td1'>活动名称(<span style='color:#F00'>*</span>)：</td><td class='table_action_td2'><input name='actionName' value='${action.title!?html}' style='width:600px;' /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <input type="hidden" id="DHtml" name="actionDescription" value="${action.description!?html}" />   
