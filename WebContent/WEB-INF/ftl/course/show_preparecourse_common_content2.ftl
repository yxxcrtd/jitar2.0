...
<a name="top"></a>
		...
		<#else>
			...
			<#else>
			<#if loginUser??>
			<div style="text-align:right;padding:4px 0"><a target="_blank" href="${SiteUrl}manage/DownloadCourseFile?p=${prepareCourse.prepareCourseId}&t=doc&f=1">下载 Word 格式</a> <a target="_blank" href="${SiteUrl}manage/DownloadCourseFile?p=${prepareCourse.prepareCourseId}&t=pdf&f=1">下载 PDF 格式</a> </div>
			</#if>
