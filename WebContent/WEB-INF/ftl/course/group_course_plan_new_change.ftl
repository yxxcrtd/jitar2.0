...
<table class='listTable' cellspacing="1" style='width:99%;'>
<tr>
<td class='boldright'>集体备课计划标题(<font color="red">*</font>)：</td><td colspan='3'><input name='plantitle' style='width:90%' /></td>
</tr>
<tr>
<td class='boldright' style='width:110px'>计划开始时间(<font color="red">*</font>)：</td><td style='width:310px'><input name='planstartdate' id='start-date' style='width:66px' readonly="readonly" />(格式：yyyy-MM-dd)<span style="color:red">创建之后开始时间不能更改</span></td>
<td class='boldright' style='width:110px'>计划结束时间(<font color="red">*</font>)：</td><td style='width:310px'><input name='planenddate' id='end-date'  style='width:66px' readonly="readonly" />(格式：yyyy-MM-dd)</td>
</tr>
<tr>
...
<tr>
<td class='boldright'>计划安排：<br><br><font style='color:#f00'>（请在右边输入框填写总体集备要求等内容；请用下表填写具体课、人、时间、要求等安排）</font> </td><td colspan='3'><input id='DHtml' name='plancontent' style='display:none' value='' />
<iframe src="${SiteUrl}manage/fckeditor/editor/fckeditor.jsp?InstanceName=DHtml&Toolbar=Default"
width="100%" height="200" frameborder="0" scrolling="no"></iframe></td>
</tr>
<tr>
...
<tr>
<td colspan='6'><input id='dhtml_1' name='content_1' style='display:none'/>
<iframe src='${SiteUrl}manage/fckeditor/editor/fckeditor.jsp?InstanceName=dhtml_1&Toolbar=Default' width='100%' height='200' frameborder='0' scrolling='no'></iframe>
</td>
</tr>
</tbody>
</table>
...
function addItem()
{
  ...
  c = document.createElement('td');
  c.colSpan = 6;
  c.innerHTML = "<input id='dhtml_"+num+"' name='content_"+num+"' style='display:none'/><iframe src='${SiteUrl}manage/fckeditor/editor/fckeditor.jsp?InstanceName=dhtml_"+num+"&Toolbar=Default' width='100%' height='200' frameborder='0' scrolling='no'></iframe>";
  r.appendChild(c)
  t.tBodies[0].appendChild(r)
