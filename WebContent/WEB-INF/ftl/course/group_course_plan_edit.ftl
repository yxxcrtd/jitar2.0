...
<tr>
<td class='boldright'>计划开始时间(<font color="red">*</font>)：</td><td><input id='start-date' disabled name='planstartdate' value='${prepareCoursePlan.startDate?string('yyyy-MM-dd')}' />(格式：年年年年-月月-日日)</td>
</tr>
<tr>
<td class='boldright'>计划结束时间(<font color="red">*</font>)：</td><td><input id='end-date' name='planenddate'' value='${prepareCoursePlan.endDate?string('yyyy-MM-dd')}' />(格式：年年年年-月月-日日)</td>
</tr>
<tr>
...
<tr>
<td class='boldright'>计划任务：</td><td><input id='DHtml' name='plancontent' style='display:none' value='${prepareCoursePlan.planContent!?html}' />
...
<#assign course_count = pc.itemOrder + 1>
	...
	从网站下载文件，编辑完成后再上传 Word 文档(.doc、.docx)方式
	<#else>
...
<tr>
<td class='boldright'>集备开始时间(<font color="red">*</font>)：</td><td><input id='pcs-date' name='startDate'  readonly="readonly" />(格式：年年年年-月月-日日)
<div style='color:#f00;display:inline'>一旦保存，则开始时间不能更改</div>
</td>
</tr>
<tr>
<td class='boldright'>集备结束时间(<font color="red">*</font>)：</td><td><input id='pce-date' name='endDate' readonly="readonly" />(格式：年年年年-月月-日日)</td>
</tr>
<tr>
<td class='boldright'>主备人：</td><td><input name='pcleaderName' id='pc_name' readonly="readonly" /><input type='hidden' name='pcLeader' id='pc_id' /> <input type='button' value='选择主备人' onclick='selectGroupUser(${group.groupId},"pc_id","pc_name")' />（如果不选，则创建者是主备人）</td>
	...
	<option value="100" selected="selected">直接上传 Word 文档(.doc、.docx)方式</option>
	</select>
...
<tr>
<td class='boldright'>备课任务：</td><td><input id='DHtml2' name='pcdesc' style='display:none' value='' />
 <iframe src="${SiteUrl}manage/fckeditor/editor/fckeditor.jsp?InstanceName=DHtml2&Toolbar=Default" width="100%" height="200" frameborder="0" scrolling="no"></iframe></td>
</tr>
</table>
<br/>
...
calendar.set("pcs-date");
calendar.set("pce-date");
</script>
<#else>
请选择一个备课计划。
</#if>
