...
<#if prepareCourse??>
	...
	<label><input type="radio" name="contentType" value="100"<#if prepareCourse.contentType == 100> checked="checked"</#if> />从网站下载文件，编辑完成后再上传 Word 文档(.doc、.docx)方式</label><br/><br/>
