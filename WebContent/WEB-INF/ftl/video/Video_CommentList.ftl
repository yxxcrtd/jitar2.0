...
<div id='MessageTip' class='message_frame' style='width:600px;' onkeydown='MessageBox.Close()'>
  ...
  <div style='padding:20px;'>
    ...
    <input type="hidden" id="DHtml" name="content" value="<span></span>" /><br/>
	<iframe id="DHtml_Frame" src="${SiteUrl}manage/fckeditor/editor/fckeditor.jsp?InstanceName=DHtml&Toolbar=Basic"
