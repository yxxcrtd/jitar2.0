...
<#if __referer??>
	...
	<tr>
		...
		<td> 
			<textarea name="content" style='display:none'>${news.content!?html}</textarea>
			<iframe id="DHtml_Frame" src="fckeditor/editor/fckeditor.jsp?InstanceName=content&Toolbar=Default" width="100%" height="400" frameborder="0" scrolling="no"></iframe>
    </td>
	</tr>
 <#if newsType??>
  <tr>
