...
<tr>
  <td align="right"><b>文章内容<font style="color: #FF0000; font-weight: bold;">*</font>：</b></td>
  <td>              
<textarea name="articleContent" id="articleContent" style="display: none;">${article.articleContent!?html}</textarea>
<iframe src="${SiteUrl}manage/fckeditor/editor/fckeditor.jsp?InstanceName=articleContent&Toolbar=Default"
