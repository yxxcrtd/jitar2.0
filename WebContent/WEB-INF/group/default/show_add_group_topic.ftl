...
<form name='topicForm' action="${SiteUrl}manage/groupBbs.action" method="post" onsubmit='return check()'>
  ...
  <table class="listTable" cellspacing='1' width="100%">
    ...
    <tr>
        ...
        <td>
        <textarea name='content' id='webEditor' style='display:none'>${topic.content!?html}</textarea>
        <iframe id="webEditor" src="${SiteUrl}manage/fckeditor/editor/fckeditor.jsp?InstanceName=webEditor&Toolbar=Basic" 
