...
<tr>
<th style='width:66px;'>调查名称：</th><td><input name='vote_title' style='width:100%' value='${vote.title?html}' /></td>
</tr>
<tr>
<th style='vertical-align:top'>调查描述：</th><td><textarea name='vote_desc' style='width:100%;height:40px'>${vote.description?html}</textarea></td>
</tr>
<tr>
<th>截止日期：</th><td><input name='vote_enddate' id='v_enddate' value='${vote.endDate?string('yyyy-MM-dd')}' /></td>
</tr>
<tr>
...
<tr>
<th style='width:66px;'>问题${q_count}：</th>
<td>
<input type='hidden' name='old_q' value='${q.question.voteQuestionId}' />
<input name='vote_q_${q.question.voteQuestionId}' value='${q.question.title?html}' style='width:90%' /></td>
</tr>
<tr>
<td>问题类型：</td><td>
...
<tr>
<td>必选个数：</td><td><input  name='vote_max_${q.question.voteQuestionId}' value='${q.question.maxSelectCount}' />（多选的时候使用，0表示不限制。）</td>
</tr>
<tr>
...
<#list q.answer as a>
	...
	<div><textarea name='q_a_${a.voteQuestionAnswerId}' style='width:100%;height:40px'>${a.answerContent?html}</textarea></div>
</#list>
	<div><textarea name='new_answer_${q.question.voteQuestionId}' style='width:100%;height:40px' onclick='addQuestionItem(event,${q.question.voteQuestionId})' onkeydown='addQuestionItem(event,${q.question.voteQuestionId})'></textarea></div>
</td>
</tr>
</#if>
</#list>
...
<input type='button' value='增加调查问题' onclick='addQuestion()' /> 
