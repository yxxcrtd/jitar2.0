...
<tr>
<th style='width:66px;'>调查名称：</th><td><input name='vote_title' style='width:100%' /></td>
</tr>
<tr>
<th style='vertical-align:top'>调查描述：</th><td><textarea name='vote_desc' style='width:100%;height:40px'></textarea></td>
</tr>
<tr>
...
<table style='width:100%'>
<tr>
<th style='width:66px;'>问题1：</th><td><input name='vote_q_1' style='width:90%' /></td>
</tr>
<tr>
<td>问题类型：</td><td>
...
<td style='vertical-align:top'>选项：</td><td id='td_1'>
	<div><textarea name='vote_a_1' style='width:100%;height:40px' onclick='addQuestionItem(event)' onkeydown='addQuestionItem(event)'></textarea></div>
	<div><textarea name='vote_a_1' style='width:100%;height:40px' onclick='addQuestionItem(event)' onkeydown='addQuestionItem(event)'></textarea></div>
</td>
</tr>
</table>
...
function addQuestion()
{
  ...
  var strHtml = "<table style='width:100%'>";
  	  strHtml += "<tr><th style='width:66px;'>问题" + q_count + "：</th><td><input name='vote_q_" + q_count + "' style='width:90%' /></td></tr>";
  	  ...
  	  strHtml += "<div><textarea name='vote_a_" + q_count + "' style='width:100%;height:40px' onclick='addQuestionItem(event)' onkeydown='addQuestionItem(event)'></textarea></div>";
  	  strHtml += "</td></tr></table>";
