...
<#if unitAdmin == "1" || unitUserAdmin == "1">
    ...
    <div id='Menu_1' class="panelItems" style='display:'>    
      ...
      <#if unitAdmin == "1" >
        ...
        <li><a href="${SiteUrl}manage/admin_stat.action?cmd=init&from=unit&unitId=${unit.unitId}" target="main" onClick="ac(this)">个人统计</a></li>
        <li><a href="${SiteUrl}manage/admin_stat_unit.action?cmd=init&from=unit&unitId=${unit.unitId}" target="main" onClick="ac(this)">机构统计</a></li>
