...
<tr>
<td>机构简介：</td><td>
<input name='unitdesc' id='unitdesc' style='width:99%;display:none' value='${unit.unitDescription!?html}' />
<iframe src="${SiteUrl}manage/fckeditor/editor/fckeditor.jsp?InstanceName=unitdesc&amp;Toolbar=Basic" scrolling="no" width="100%" frameborder="0" height="300"></iframe>
</td>
</tr>
-->
<tr>
