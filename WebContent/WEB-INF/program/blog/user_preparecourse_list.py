...
class user_preparecourse_list(BaseAction, RequestMixiner, ResponseMixiner, PageCheckMixiner):
    def __init__(self):
    ...
    def execute(self):
        ...
        qry = PrepareCourseQuery(""" pc.prepareCourseId,pc.title, pc.createDate,pc.memberCount,pc.articleCount,pc.resourceCount,pc.actionCount,pc.topicCount,pc.topicReplyCount """)
        qry.status = 0
        ...
        return "/WEB-INF/user/default/user_preparecourse_list.ftl"