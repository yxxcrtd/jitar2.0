...
<tr>
<th style='width:80px;'>调查名称：</th><td><input name='vote_title' style='width: 100%; height: 25px; outline: none; border: 1px solid #000000;' value='${vote.title?html}' /></td>
</tr>
<tr>
<th style='vertical-align:top'>调查描述：</th><td><textarea name='vote_desc' style='width: 100%; height: 80px; outline: none; border: 1px solid #000000;'>${vote.description?html}</textarea></td>
</tr>
<tr>
<th>截止日期：</th><td style="text-align: left;"><input name='vote_enddate' id='v_enddate' value='${vote.endDate?string('yyyy-MM-dd')}' style='width: 30%; height: 25px; outline: none; border: 1px solid #000000;' /></td>
</tr>
<tr>
...
<input name='vote_q_${q.question.voteQuestionId}' value='${q.question.title?html}' style='width: 100%; height: 25px; outline: none; border: 1px solid #000000;' /></td>
</tr>
<tr>
<td>问题类型：</td>
...
<tr>
<td>必选个数：</td><td style="text-align: left;"><input  name='vote_max_${q.question.voteQuestionId}' value='${q.question.maxSelectCount}' style='width: 50%; height: 25px; outline: none; border: 1px solid #000000;' />（多选的时候使用，0表示不限制。）</td>
</tr>
<tr>
...
<#list q.answer as a>
	...
	<div><textarea name='q_a_${a.voteQuestionAnswerId}' style='width:100%;height:50px;border: 1px solid #000000;'>${a.answerContent?html}</textarea></div>
</#list>
	<div><textarea name='new_answer_${q.question.voteQuestionId}' style='width:100%;height:40px;border: 1px solid #000000;' onclick='addQuestionItem(event,${q.question.voteQuestionId})' onkeydown='addQuestionItem(event,${q.question.voteQuestionId})'></textarea></div>
</td>
</tr>
</#if>
</#list>
...
function addQuestion()
{
  ...
  var strHtml = "<table style='width:100%'>";
  	  strHtml += "<tr><th style='width:66px;'>问题" + oldQuestionCount + "：</th><td><input name='new_vote_q_" + q_count + "' style='width:90%' /></td></tr>";
  	  ...
  	  strHtml += "<div><textarea name='new_vote_a_" + q_count + "' style='width:100%;height:40px'></textarea></div>";
   	  strHtml += "</td></tr></table>";
