...
<div class="main">
    ...
    <div class="content clearfix mt75">
        ...
        <div class="contentLeft">
            <h1 title="${resource.title!?html}"><span class="uploadTime">上传时间： ${resource.createDate?string('yyyy-MM-dd HH:mm')}</span>${Util.getCountedWords(resource.title!?html,28)}</h1>
            <div class="detail" style="min-height:256px">
            <#if error??>
              <div style="color:#f00;padding:100px 0;text-align:center;font-size:2em;">${error}</div>
            <#else>
              <#if resType??>
                <#if resType == "image">
                ...
                <#elseif resType == "swf">
                 ...
                 <#else>
                 <div style="color:#f00;padding:100px 0;text-align:center;font-size:2em;">该资源属于不可预览的资源，请下载后观看。</div>
                </#if>
              <#else>
                <div style="color:#f00;padding:100px 0;text-align:center;font-size:2em;">该资源属于不可预览的资源，请下载后观看。</div>
              </#if>
