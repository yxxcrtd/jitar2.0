...
<div>
    ...
    <tr>
        <td colspan="2">
            <div>
                <input type="button" style="cursor:pointer;width:140px;height:30px;font-size:larger;background-color:blue;color:white;font-weight:bold;" name="btnAddContent" value="参与评课" onClick="inputContent()"/>
            </div>
