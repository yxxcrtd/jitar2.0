...
public class SiteIndexAction extends AbstractBasePageAction {
    ...
    protected String execute(String cmd) throws Exception {
        ...
        // 推荐协作组、最新协作组、优秀团队
        this.getRcmdGroupList();
        this.getNewGroupList();
        this.getBestGroupList();

        // 名师、学科带头人、教研之星、教研员
        this.getFamousUserList();
        this.getExpertUserList();
        this.getStarUserList();
        this.getInstructorUserList();
     ...
     */
    @SuppressWarnings("rawtypes")
    private void getFamousUserList() {
     ...
     */
    @SuppressWarnings("rawtypes")
    private void getExpertUserList() {
     ...
     */
    @SuppressWarnings("rawtypes")
    private void getInstructorUserList() {
     ...
     */
    @SuppressWarnings("rawtypes")
    private void getPrepareCourseList() {
     ...
     */
    @SuppressWarnings("rawtypes")
    private void getTeacherFengcaiList() {
    ...
    private void showActionList() {
        ...
        if (null == jitar_actions || jitar_actions.size() == 0) {
            ...
            jitar_actions = (List) qry.query_map(8);
    ...
    private void showNewResourceList() {
        ...
        if (null == new_resource_list || new_resource_list.size() == 0) {
            ...
            new_resource_list = (List) qry.query_map(10);
    ...
    private void showPlacardList() {
        ...
        if (null == site_placard_list || site_placard_list.size() == 0) {
            ...
            qry.objType = 100;
            site_placard_list = (List) qry.query_map(4);
