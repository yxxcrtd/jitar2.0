...
//		}		
	...
	private String xmlrpcUpdpwd_SSO(){
        ...
        try {
            ...
            result = userService.updatePwdRemote(getLoginUser().getUserGuid(), com.chinaedustar.util.MD5.crypt(newPassword), com.chinaedustar.util.MD5.crypt(password));
	...
	private String savephotofile() throws IOException{
        ...
        //System.out.println(" photofile = " + root+"\\"+photofile);
        //System.out.println(" mini_photofile = " + root+"\\"+"mini_"+photofile);
