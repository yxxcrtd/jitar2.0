...
public class JitarConst {
    ...
    public static final int MAX_TITLE_LENGTH = 200; // 文章标题最大长度
    public static final int MIN_TITLE_LENGTH = 10; // 文章标题最短长度
    public static final int MIN_ARTICLE_LENGTH = 200; // 文章内容字数限制
